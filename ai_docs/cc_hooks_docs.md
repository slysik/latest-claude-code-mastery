...
> Last updated: 2026-01-12T09:15:29.486750
...
* [Hooks in Skills, Agents, and Slash Commands](#hooks-in-skills%2C-agents%2C-and-slash-commands)
...
In addition to settings files and plugins, hooks can be defined directly in [Skills](/docs/en/skills), [subagents](/docs/en/sub-agents), and [slash commands](/docs/en/slash-commands) using frontmatter. These hooks are scoped to the component’s lifecycle and only run when that component is active.
